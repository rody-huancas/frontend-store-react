...
export const CardProduct = ({ product }) => {
  ...
  return (
    <div className="w-full sm:w-[330px] xl:w-96 h-96 bg-white dark:bg-gray-800 dark:text-gray-100 shadow-lg rounded-xl flex flex-col items-center gap-4 overflow-hidden relative item_product">
